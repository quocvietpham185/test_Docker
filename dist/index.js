...
app.get('/users', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, database_1.default.query('SELECT * FROM public.users')];
            case 1:
                result = _a.sent();
...
app.post('/users', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, result, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, database_1.default.query('INSERT INTO users (name, email) VALUES ($1, $2) RETURNING *', [name, email])];
            case 2:
                result = _b.sent();
...
app.put('/users/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, name, email, result, err_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, database_1.default.query('UPDATE users SET name = $1, email = $2 WHERE id = $3 RETURNING *', [name, email, id])];
            case 2:
                result = _b.sent();
                res.json(result.rows[0]);
                return [3 /*break*/, 4];
